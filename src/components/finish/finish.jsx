...
class Finish extends React.Component {
    ...
    onNextStep() {
        ...
        const timezone = this.onChoseTimezone(document.getElementById('timezone').value);
        ...
        .then(function (data) {  
            if (data.status === 200) {
                if (name && surname && gender !== 'Gender' && timezone) {
                    ctx.props.onNextStep(email.value, name, surname, gender, company, timezone)
                } 
            } 
        }) 
    ...
    <React.Fragment>
      ...
      <div className="col-12 col-sm-10 col-md-8	col-lg-6 col-xl-5"> 
        <div className="progress" id='progress'>
            <div className="progress-bar" style={{width: '100%'}}id='progress-bar' role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
        </div>
      </div>
      <div className="field-wrapper col-12 col-sm-10 col-md-8	col-lg-6 col-xl-5"> 
        <p className="text-justify">Email</p>
        <input type="text" className="form-control inputData inputEmail text-muted" id="email"placeholder="email" defaultValue={this.props.email} onChange={this.onChangeHandler.bind(this)}/>
      </div>
      <div className="field-wrapper col-12 col-sm-10 col-md-8	col-lg-6 col-xl-5"> 
        <p className="text-justify">First name</p>
        <input type="text" className="form-control inputData inputName text-muted" placeholder="First name" defaultValue={this.props.name} onChange={this.onChangeHandler.bind(this)}/>
      </div>
      <div className="field-wrapper col-12 col-sm-10 col-md-8	col-lg-6 col-xl-5"> 
        <p className="text-justify">Last name</p>
        <input type="text" className="form-control inputData inputSurname text-muted" placeholder="Second name" defaultValue={this.props.surname} onChange={this.onChangeHandler.bind(this)}/>
      </div>
      <div className="field-wrapper col-12 col-sm-10 col-md-8	col-lg-6 col-xl-5"> 
      ...
      <div className="field-wrapper col-12 col-sm-10 col-md-8	col-lg-6 col-xl-5"> 
        ...
        <input type="text" className="form-control inputData inputCompany text-muted" placeholder="Company" defaultValue={this.props.company}/>
      </div>
      <div className="field-wrapper timezone-wrapper col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5"> 
        ...
        <select className="timezone form-control" name="timezone" id="timezone" defaultValue={this.props.timezone}>
      ...
      <div className="container">
          <div className="col-sm">
            <button className="btn btn-primary btn-block" id='btn-next' onClick={this.onNextStep.bind(this)}>CREATE ACCOUNT</button>
          </div>
      </div>
    </React.Fragment>
    )
